...
Installation_dependency(){
	...
	if [[ ${release} = "centos" ]]; then
		...
		aptitude update
		aptitude install vim pkg-config build-essential libgnutls28-dev libwrap0-dev liblz4-dev libseccomp-dev libreadline-dev libnl-nf-3-dev libev-dev gnutls-bin -y
